export default function Index() {
  return (
    <article>
      <section>
        <p>Hi, I am Stephan van Opstal, your not so average front-end engineer. Besides my coding skills, I am that experienced senior developer that asks questions, motivates the team and tries to improve the process.</p>
        <p>I love building complex web applications with <strong>React</strong> en <strong>TypeScript</strong>. I am also very comfortable with <strong>Next.js</strong>, <strong>GraphQL</strong>, <strong>Jest</strong> and <strong>Testing Library</strong>.</p>
