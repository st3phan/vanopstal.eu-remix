      ...
      <section>
        ...
        <section>
          ...
          <p>As part of a scrum team, I was responsible for setting up a <strong>Patternlab</strong>. This
            ...
            8.2
            environment.</p>
          <p>As front-end developer, not only was I responsible for the actual technical implementation in the front-end
        ...
        <section>
          ...
          <p>I helped develop an app with accompanying website for the <em>NGF</em> (Dutch Golf Federation). My
            ...
            and the Sitecore/iOS developers because the main focus of the design was on the app and the website had to
            match that as closely as possible. Long-term project of several months in a SCRUM team. Some of the
            techniques
        ...
        <section>
          ...
          <p>I worked on the iOS/Android/Windows app with accompanying website and CMS system. The hybrid app
            ...
            framework.
            The back-end was built in <strong>PHP</strong> using Twig as the template engine. Besides
